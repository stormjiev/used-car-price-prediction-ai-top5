...
for kind, kind_data in Train_gb:
    ...
    info['regionCode_mad'] = kind_data.price.std()
...
for kind, kind_data in Train_gb:
    ...
    info['brand_price_mad'] = kind_data.price.std()
...
for kind, kind_data in Train_gb:
    ...
    info['model_price_mad'] = kind_data.price.std()
    all_info[kind] = info
...
for kind, kind_data in Train_gb:
    ...
    info['kilometer_price_mad'] = kind_data.price.std()
...
for kind, kind_data in Train_gb:
    ...
    info['bodyType_price_mad'] = kind_data.price.std()
...
for kind, kind_data in Train_gb:
    ...
    info['fuelType_price_mad'] = kind_data.price.std()
...
tree_data[train_num:train_num+50000].to_csv(output_path+'test_tree.csv', index=0,sep=' ')
